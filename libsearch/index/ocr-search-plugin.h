#ifndef OCRSEARCHPLUGIN_H
#define OCRSEARCHPLUGIN_H
...
namespace Zeeker {
//internal plugin
class LIBSEARCH_EXPORT OcrSearchPlugin : public QObject, public SearchPluginIface
{
    Q_OBJECT
public:
    OcrSearchPlugin(QObject *parent = nullptr);
